    ...
    <section id="top" className="relative pt-[clamp(3rem,2rem+4vw,7rem)] pb-[clamp(2rem,1rem+3.5vw,5rem)]">
      <div className="max-w-[1380px] mx-auto px-5 sm:px-6 lg:px-10">
        <div className="text-center max-w-5xl mx-auto pt-4 lg:pt-12">
          ...
          <p className="eyebrow mt-4 lg:mt-5 animate-slide-up delay-100">{t.hero.eyebrow}</p>
          <h1 className="mt-4 lg:mt-6 headline fluid-h1 text-[var(--color-ink)] animate-slide-up delay-200">              
            {t.hero.titleA}
            <span className="italic font-light text-[var(--color-clay-deep)]"> {t.hero.titleB}</span>
          </h1>
          <p className="mt-5 lg:mt-7 max-w-2xl mx-auto fluid-body text-[var(--color-ink-soft)] animate-slide-up delay-300">              
            {t.hero.body}
          </p>
          <div className="mt-6 lg:mt-9 flex flex-wrap items-center justify-center gap-2 lg:gap-3 animate-slide-up delay-400">              
            <Link
              to={r.configurator}
        ...
        <div className="mt-10 lg:mt-20 relative animate-slide-up delay-400">
          <div className="mt-10 lg:mt-20 relative">
            <ImageSlot
              ...
              width={1200}
              height={578}
              // 直接写死 public 文件夹下的绝对路径
              srcSet="
                /showcase/hero-living-640.webp 640w, 
                /showcase/hero-living-800.webp 800w, 
                /showcase/hero-living-1024.webp 1024w, 
                /showcase/hero-living.webp 1200w
              "
              sizes="
        ...
        <dl className="mt-[clamp(2.5rem,1rem+5vw,7rem)] grid grid-cols-2 lg:grid-cols-4 gap-px bg-[var(--color-line)] border border-[var(--color-line)] rounded-md overflow-hidden animate-slide-up" style={{ animationDelay: '0.5s' }}>            
